...
import { ArrowLeft, Code2, Database, Github, Layers3, Server, X } from "lucide-react";
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
                ...
                <div className="flex-1 space-y-6 overflow-y-auto p-6 md:p-8">
                    ...
                    <div>
                        <h3 className="text-xs font-extrabold uppercase tracking-[0.18em] text-muted-foreground">
                            Características
                        </h3>
        ...
        <div className="min-h-screen pt-28 pb-16">
            <Container>
                ...
                <div className="mb-10 max-w-3xl">
                    <p className="mb-3 text-xs font-extrabold uppercase tracking-[0.22em] text-sky-700 dark:text-cyan-200">
                        Portafolio técnico
                    </p>
                    <h1 className="font-heading text-4xl font-extrabold md:text-5xl">
                        Proyectos, módulos y soluciones de negocio
                    </h1>
                    <p className="mt-4 text-base leading-relaxed text-muted-foreground md:text-lg">
                        Cada ficha resume qué problema resuelve, qué stack usa y qué valor aporta
                        dentro de un contexto empresarial o de producto web.
                    </p>
                </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="flex flex-1 flex-col justify-between p-6">
                                    <div>
                                        <h2 className="line-clamp-1 font-heading text-lg font-extrabold text-foreground">
                                            {project.title}
                                        </h2>
